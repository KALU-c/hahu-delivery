...
const foodList = [
  { id: 1, name: "Burger", restaurant: "The Burger Joint", price: 8.99 },
  { id: 2, name: "Pizza", restaurant: "Pizza Paradise", price: 12.99 },
  { id: 3, name: "Sushi", restaurant: "Sushi World", price: 15.99 },
  { id: 4, name: "Pasta", restaurant: "Pasta Palace", price: 10.99 },
  { id: 5, name: "Salad", restaurant: "Fresh Greens", price: 7.99 },
  { id: 6, name: "Tacos", restaurant: "Taco Haven", price: 9.49 },
  { id: 7, name: "Steak", restaurant: "The Grill House", price: 20.99 },
  { id: 8, name: "Sandwich", restaurant: "Deli Delights", price: 6.99 },
  { id: 9, name: "Chicken Wings", restaurant: "Wing Central", price: 11.99 },
];
